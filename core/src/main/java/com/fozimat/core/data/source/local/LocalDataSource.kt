package com.fozimat.core.data.source.local

import com.fozimat.core.data.source.local.entity.TourismEntity
import com.fozimat.core.data.source.local.room.TourismDao
